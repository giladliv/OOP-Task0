...
public class Ex0_main {
    public static Long ID0=206768962L, ID1 = 316320282L, ID2 = null;
    public static void main(String[] ar) {
        ...
        ElevatorAlgo ex0_alg = new SmartElevatorAlgo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
        //ElevatorAlgo ex0_alg = new BetterAlgo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
